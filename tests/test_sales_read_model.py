...
def test_classify_it_av() -> None:
    ...
    sj1 = {"bravo_subject@OData.Community.Display.V1.FormattedValue": "av; smartbygg"}
    assert classify_it_av(sj1) == "av"

    sj2 = {"bravo_subject@OData.Community.Display.V1.FormattedValue": "it"}
    assert classify_it_av(sj2) == "it"

    sj3 = {"bravo_subject@OData.Community.Display.V1.FormattedValue": "av; it"}
    ...
    sj6 = {"bravo_customerneeds": "Microsoft 365 setup and neat meeting screen"}
    ...
    async with pg_pool.acquire() as conn:
        async with conn.transaction():
            ...
            await _insert_sales_record(
                ...
                acc_id_1,
                "Acme Corp",
                {"accountid": acc_id_1, "address1_city": "Oslo", "bravo_industry": "NACE (62)"},
            )
            await _insert_sales_record(
                conn,
                namespace_id,
        ...
        async with conn.transaction():
            ...
            await _insert_sales_record(
                ...
                "AV installation in classroom",
                {
                    ...
                    "bravo_customerneeds": "Videobar neatly installed in room",
                    "_ownerid_value": user_guid,
                },
            )
