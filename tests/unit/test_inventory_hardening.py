...
_TOTAL_TOOLS = 248  # 247 baseline + 1 Project tool (Wave C-PJ2)
_MUTATION_TOOLS = 111  # 110 baseline + 1 Project mutation (Wave C-PJ2)
_CACHEABLE_TOOLS = 94  # 94 cacheable
_ADMIN_ONLY_TOOLS = 72  # 71 baseline + 1 Project admin tool (Wave C-PJ2)
_MIGRATION_TOOLS = 5
