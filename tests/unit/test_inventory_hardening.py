...
_TOTAL_TOOLS = 233  # 228 baseline + 5 HR tools (Wave HR-2)
_MUTATION_TOOLS = 101  # 99 baseline + 2 HR mutations
_CACHEABLE_TOOLS = 89  # 86 baseline + 3 HR cacheable reads
_ADMIN_ONLY_TOOLS = 63  # 61 baseline + 2 HR admin tools
_MIGRATION_TOOLS = 5
