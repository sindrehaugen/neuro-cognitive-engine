...
_TOTAL_TOOLS = 214  # 206 baseline + 6 economy (Wave E-1) + 1 sales signing request (Wave S-2a) + 1 decision feedback (Wave C10)
_MUTATION_TOOLS = 89  # 87 baseline + 1 sales signing request + 1 decision feedback
