...
_TOTAL_TOOLS = 166  # +8 marketing tools (ML14-B3, M14.W3)
_MUTATION_TOOLS = 71  # +5 mutating marketing tools
_CACHEABLE_TOOLS = 57  # +3 cacheable marketing tools
_ADMIN_ONLY_TOOLS = 37  # +5 admin_only marketing tools
_MIGRATION_TOOLS = 5
