...
# --- MEASURED post-rebase onto da68095 (#243/#251/#237/#249/#250/#255/#256/
# #257/#239/#248/#246/#244) plus this branch's own field_tech WORK_ORDER/
# TIME_ENTRY/CHECKLIST C12 registration (Lane E Wave E-10):
...
# Wave F-12) hand-written + 80 live C12 tools (16 Inventory + 8
...
# TIME_ENTRY/CHECKLIST, Lane E Wave E-10) = 368. See
# tests/test_tool_registry.py for the equivalent derived hand-written/C12
# split for MUTATION (126 hand-written incl. BRREG+both geodata waves + 40
# live C12 = 166) and CACHEABLE (117 hand-written incl. both geodata waves
# + 40 live C12 = 157); ADMIN_ONLY (96) is unaffected by field_tech -- E-10
# registered no admin_only tools.
_TOTAL_TOOLS = 368
_MUTATION_TOOLS = 166
_CACHEABLE_TOOLS = 157
