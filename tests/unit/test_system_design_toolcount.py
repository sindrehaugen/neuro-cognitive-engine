...
#
# The pin itself lives in tests/tool_pins.py (FLAG_PINS["system_design"]) --
# that is the one file to edit when a system_design_* tool is added, removed,
# or has its flags changed. See that module's docstring for why.
# ---------------------------------------------------------------------------

_EXPECTED_TOOLS: dict[str, dict[str, bool]] = FLAG_PINS["system_design"]
