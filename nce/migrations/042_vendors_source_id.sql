-- 042_vendors_source_id.sql
-- Add per-vertical vendors_source_id column to kg_nodes and kg_edges.
-- Mirrors the system_design_source_id pattern.
-- Enables hard-retirement of vendors-derived rows when the source record is
