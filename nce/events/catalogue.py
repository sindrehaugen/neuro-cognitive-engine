...
EVENT_CATALOGUE: Mapping[str, EventContract] = {
    ...
    "BOM_LINE.upserted": EventContract(
        ...
        declared_consumers=("nce/read_model_subscribers.py",),
        status="ACTIVE",
    ...
    "DESIGN_REQUEST.created": EventContract(
        selector="DESIGN_REQUEST.created",
        node_type="DESIGN_REQUEST",
        op="created",
        declared_producers=("nce/vertical_modules/system_design/design_requests.py",),
        declared_consumers=(),
        status="UNCONSUMED",
        description="Emitted when a solution design intake request is created.",
    ),
    "DESIGN_REQUEST.updated": EventContract(
        selector="DESIGN_REQUEST.updated",
        node_type="DESIGN_REQUEST",
        op="updated",
        declared_producers=("nce/vertical_modules/system_design/design_requests.py",),
        declared_consumers=(),
        status="UNCONSUMED",
        description="Emitted when a solution design intake request is updated or assigned.",
    ),
    "DESIGN_REQUEST.completed": EventContract(
        selector="DESIGN_REQUEST.completed",
        node_type="DESIGN_REQUEST",
        op="completed",
        declared_producers=("nce/vertical_modules/system_design/design_requests.py",),
        declared_consumers=(),
        status="UNCONSUMED",
        description="Emitted when a solution design intake request is completed and linked to a DESIGN.",
    ),
