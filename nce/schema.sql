...
-- Table backing PO_LINE entity and status state machine.
-- ============================================================================
...
-- ============================================================================
-- DECISION-FEEDBACK SERVICE (Module 0 / Cross-Engine C10, migration 075)
-- Tables:
--   1. decision_feedback (ground-truth human decision signal across vertical engines)
-- ============================================================================
...
-- ============================================================================
-- SIGNING PROVIDER CREDENTIALS (Sales / Signing Service Wave Q-4, migration 076)
-- Tables:
--   1. signing_credentials (encrypted broker credentials per tenant namespace)
-- ============================================================================
...
-- Migration 084_document_register.sql
-- ============================================================================
...
-- Migration 088_sales_resource_tables.sql
-- ============================================================================
...
-- Shared pricing service, FX rate feed last-good persistence (Wave F-15,
-- migration 092). GLOBAL, not tenant-scoped -- see that migration's
...
-- Migration 093_principal_bindings.sql
-- ============================================================================
...
DROP POLICY IF EXISTS tenant_isolation_policy ON principal_bindings;
...
-- Migration 096_agreement_parties_and_resources.sql
-- ============================================================================
