...
_PROFILE_LABEL: dict[str, str] = {
    "bravo_standard": "Bravo-standard (100% HW signing, 50/50 services)",
...
def generate_sow(sow_input: SoWInput, version_number: int = 1) -> SoWDoc:
    ...
    summary_parts: list[str] = [
        f"Bravo Audio Visual leverer {total_lines} komponenter fordelt over {total_rooms} rom "
    ...
    terms: list[str] = [
        ...
        "Bravo Audio Visual beholder eierskap til leveranser inntil full betaling er mottatt.",
