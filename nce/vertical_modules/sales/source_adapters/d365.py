...
_SELECT_FIELDS = {
    "accounts": ["accountid", "name", "address1_city", "bravo_industry", "modifiedon"],
    ...
    "opportunities": [
        ...
        "bravo_estrecurringmonthly",
        "bravo_estrecurringmonthly_base",
        "bravo_customerneeds",
        "bravo_jobdescription",
        "description",
        "bravo_subject@OData.Community.Display.V1.FormattedValue",
        "modifiedon",
    ],
