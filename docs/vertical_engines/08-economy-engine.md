...
<!-- SHIPPED SPECIFICATION. At baseline 6643ce6, Economy ships 15 MCP tools and 13 REST routes (see docs/_generated/surface.md and docs/_generated/engine_figures.md). Direct Finago GL posting remains locked by CFO policy. Refer to docs/engines/economy-user.md and docs/engines/economy-admin.md for shipped operator reality. Verified-against: 6643ce6 -->
...
## Core functions
<!-- Domain cores and exposed MCP/REST tools are documented in docs/_generated/surface.md (15 MCP tools and 13 REST routes at 6643ce6). do_cascade_on_approval and direct GL posting remain unwired to autonomous mutation dispatch by policy. -->
...
## MCP tools
<!-- Shipped MCP tools. Economy registers 15 MCP tools in TOOL_REGISTRY (see docs/_generated/surface.md and docs/_generated/engine_figures.md). AI-role tag per roadmap §2 taxonomy. -->
...
## REST routes
<!-- Shipped REST routes. 13 REST endpoints mounted under /api/economy in nce/admin_handlers/economy.py (see docs/_generated/surface.md). -->
...
## Build phases
<!-- Historical build phases B1-B5. Refer to docs/engines/economy-admin.md for shipped milestone status. -->
