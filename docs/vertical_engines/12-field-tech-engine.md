...
- **Host Portal page(s) served:** the (new) field/dispatch surface + the restricted external-contractor mobile view; install/service status feeds the room-centric customer view.
