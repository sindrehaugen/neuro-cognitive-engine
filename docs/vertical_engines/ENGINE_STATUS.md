> **Status:** shipped · **Verified-against:** `8c5e709e` (public `main`) · **Last-audited:** 2026-09-20
...
| `TOOL_REGISTRY` entries | **549** MCP tools (70 shared + 479 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
