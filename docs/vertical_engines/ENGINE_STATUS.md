> **Status:** shipped · **Verified-against:** `7781403` (public `main`) · **Last-audited:** 2026-09-17
...
## Measured inventory at `7781403`

| Instrument | Value |
|---|---|
| Module packages under `nce/vertical_modules/` | **20** (17 engines + `diagnostics`, `dynamics365`, `netbox`) |
| `TOOL_REGISTRY` entries | **276** MCP tools (69 shared + 207 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
