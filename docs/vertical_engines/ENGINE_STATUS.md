> **Status:** shipped · **Verified-against:** `7356624` (public `main`) · **Last-audited:** 2026-09-18
...
| `TOOL_REGISTRY` entries | **335** MCP tools (69 shared + 266 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
