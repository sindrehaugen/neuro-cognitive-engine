> **Status:** shipped · **Verified-against:** `44ffd2c` (public `main`) · **Last-audited:** 2026-09-17
...
## Measured inventory at `44ffd2c`

| Instrument | Value |
|---|---|
| Module packages under `nce/vertical_modules/` | **20** (17 engines + `diagnostics`, `dynamics365`, `netbox`) |
| `TOOL_REGISTRY` entries | **279** MCP tools (69 shared + 210 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
