> **Status:** shipped · **Verified-against:** `b19e66ba` (public `main`) · **Last-audited:** 2026-09-20
...
| `TOOL_REGISTRY` entries | **547** MCP tools (70 shared + 477 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
