> **Status:** shipped · **Verified-against:** `6ff52e0` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **352** MCP tools (69 shared + 283 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
...
| v1.6 C12 resource-surface registrations | **9 of 24** engines have `resources.py` — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
