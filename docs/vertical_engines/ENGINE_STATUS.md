> **Status:** shipped · **Verified-against:** `6c94428` (public `main`) · **Last-audited:** 2026-09-20
...
| `TOOL_REGISTRY` entries | **528** MCP tools (70 shared + 458 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
...
| SQL migrations | 94 files (+1 optional), `001` → `098` — gaps at `002`, `009`, `059` (never allocated); `010` exists only under `nce/migrations/optional/`. — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
