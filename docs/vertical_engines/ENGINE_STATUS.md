> **Status:** shipped · **Verified-against:** `c5c9844` (public `main`) · **Last-audited:** 2026-09-20
...
| SQL migrations | 96 files (+1 optional), `001` → `103` — gaps at `002`, `009`, `059` (never allocated); `010` exists only under `nce/migrations/optional/`. — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
