> **Status:** shipped · **Verified-against:** `473bd69` (public `main`) · **Last-audited:** 2026-09-17
...
## Measured inventory at `473bd69`

| Instrument | Value |
|---|---|
| Module packages under `nce/vertical_modules/` | **20** (17 engines + `diagnostics`, `dynamics365`, `netbox`) |
| `TOOL_REGISTRY` entries | **277** MCP tools (69 shared + 208 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
