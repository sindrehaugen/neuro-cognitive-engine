> **Status:** shipped · **Verified-against:** `c233e1f` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **421** MCP tools (70 shared + 351 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
