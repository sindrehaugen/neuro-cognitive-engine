> **Status:** shipped · **Verified-against:** `b5d7d28` (public `main`) · **Last-audited:** 2026-09-20
...
| SQL migrations | 98 files (+1 optional), `001` → `102` — gaps at `002`, `009`, `059` (never allocated); `010` exists only under `nce/migrations/optional/`. — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
| `EXPECTED_TENANT_RLS_TABLES` | **113** |
