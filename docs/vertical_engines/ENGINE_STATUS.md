> **Status:** shipped · **Verified-against:** `54d9bcd` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **435** MCP tools (70 shared + 365 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
