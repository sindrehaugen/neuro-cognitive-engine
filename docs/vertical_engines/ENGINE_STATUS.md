> **Status:** shipped · **Verified-against:** `6f8d827` (public `main`) · **Last-audited:** 2026-09-20
...
| `TOOL_REGISTRY` entries | **551** MCP tools (70 shared + 481 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
