> **Status:** shipped · **Verified-against:** `ca0d22a` (public `main`) · **Last-audited:** 2026-09-21
...
| `TOOL_REGISTRY` entries | **526** MCP tools (70 shared + 456 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
