> **Status:** shipped · **Verified-against:** `6e066bc` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **486** MCP tools (70 shared + 416 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
