> **Status:** shipped · **Verified-against:** `61cbf8c` (public `main`) · **Last-audited:** 2026-09-20
...
| `TOOL_REGISTRY` entries | **530** MCP tools (70 shared + 460 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
