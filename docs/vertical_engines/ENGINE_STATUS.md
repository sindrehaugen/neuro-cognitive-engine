> **Status:** shipped · **Verified-against:** `62e5fd4` (public `main`) · **Last-audited:** 2026-09-18
...
| `TOOL_REGISTRY` entries | **331** MCP tools (69 shared + 262 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
...
| v1.6 C12 resource-surface registrations | **7 of 23** engines have `resources.py` — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
