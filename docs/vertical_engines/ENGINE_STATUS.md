> **Status:** shipped · **Verified-against:** `ca6e1be` (public `main`) · **Last-audited:** 2026-09-20
...
| `TOOL_REGISTRY` entries | **525** MCP tools (70 shared + 455 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
