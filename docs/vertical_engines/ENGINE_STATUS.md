> **Status:** shipped · **Verified-against:** `c76f53a` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **392** MCP tools (70 shared + 322 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
