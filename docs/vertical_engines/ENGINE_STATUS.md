> **Status:** shipped · **Verified-against:** `06156f4` (public `main`) · **Last-audited:** 2026-09-19
...
| SQL migrations | 87 files (+1 optional), `001` → `094` — gaps at `002`, `009`, `059` (never allocated); `010` exists only under `nce/migrations/optional/`. — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
| `EXPECTED_TENANT_RLS_TABLES` | **98** |
