> **Status:** shipped · **Verified-against:** `11f2cd1` (public `main`) · **Last-audited:** 2026-09-20
...
| `TOOL_REGISTRY` entries | **519** MCP tools (70 shared + 449 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
