> **Status:** shipped · **Verified-against:** `913ba04` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **384** MCP tools (70 shared + 314 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
