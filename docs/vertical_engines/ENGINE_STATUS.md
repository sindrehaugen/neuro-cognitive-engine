> **Status:** shipped · **Verified-against:** `5300987` (public `main`) · **Last-audited:** 2026-09-20
...
| `TOOL_REGISTRY` entries | **529** MCP tools (70 shared + 459 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
...
| SQL migrations | 95 files (+1 optional), `001` → `099` — gaps at `002`, `009`, `059` (never allocated); `010` exists only under `nce/migrations/optional/`. — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
| `EXPECTED_TENANT_RLS_TABLES` | **109** |
