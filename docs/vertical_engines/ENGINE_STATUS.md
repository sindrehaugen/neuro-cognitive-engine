> **Status:** shipped · **Verified-against:** `b1dcfb5` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **404** MCP tools (70 shared + 334 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
...
| SQL migrations | 90 files (+1 optional), `001` → `095` — gaps at `002`, `009`, `059` (never allocated); `010` exists only under `nce/migrations/optional/`. — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
| `EXPECTED_TENANT_RLS_TABLES` | **100** |
...
| v1.6 C12 resource-surface registrations | **13 of 25** engines have `resources.py` — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
