> **Status:** shipped · **Verified-against:** `1ae7b5d` (public `main`) · **Last-audited:** 2026-09-20
...
| `TOOL_REGISTRY` entries | **509** MCP tools (70 shared + 439 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
...
| v1.6 C12 resource-surface registrations | **18 of 25** engines have `resources.py` — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
