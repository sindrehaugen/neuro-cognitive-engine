> **Status:** shipped · **Verified-against:** `18616ab` (public `main`) · **Last-audited:** 2026-09-20
...
| `TOOL_REGISTRY` entries | **518** MCP tools (70 shared + 448 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
