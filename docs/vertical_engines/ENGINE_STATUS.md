> **Status:** shipped · **Verified-against:** `f9c5666` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **368** MCP tools (69 shared + 299 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
