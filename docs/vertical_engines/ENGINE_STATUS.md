> **Status:** shipped · **Verified-against:** `56a7ac8` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **425** MCP tools (70 shared + 355 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
