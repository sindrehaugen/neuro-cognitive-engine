> **Status:** shipped · **Verified-against:** `9d06fbc` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **439** MCP tools (70 shared + 369 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
