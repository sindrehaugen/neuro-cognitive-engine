> **Status:** shipped · **Verified-against:** `b6834d0` (public `main`) · **Last-audited:** 2026-09-20
...
| `TOOL_REGISTRY` entries | **555** MCP tools (70 shared + 485 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
