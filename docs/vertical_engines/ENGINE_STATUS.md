> **Status:** shipped · **Verified-against:** `7d7ecf7` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **455** MCP tools (70 shared + 385 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
