> **Status:** shipped · **Verified-against:** `1999c12` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **433** MCP tools (70 shared + 363 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
