> **Status:** shipped · **Verified-against:** `6f86558` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **458** MCP tools (70 shared + 388 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
...
| v1.6 C12 resource-surface registrations | **15 of 25** engines have `resources.py` — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
