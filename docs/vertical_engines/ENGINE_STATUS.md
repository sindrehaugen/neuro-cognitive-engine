> **Status:** shipped · **Verified-against:** `a84cef9` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **340** MCP tools (69 shared + 271 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
