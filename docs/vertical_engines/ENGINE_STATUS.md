> **Status:** shipped · **Verified-against:** `6dbe622` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **372** MCP tools (70 shared + 302 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
