> **Status:** shipped · **Verified-against:** `c74f6f4` (public `main`) · **Last-audited:** 2026-09-19
...
| `TOOL_REGISTRY` entries | **405** MCP tools (70 shared + 335 engine) — see [`docs/_generated/engine_figures.md`](../_generated/engine_figures.md) |
