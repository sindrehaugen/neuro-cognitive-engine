...
- **Host Portal pages served:** the HR dashboard page, `Brukere.jsx` (employee list), `BrukerDetalj.jsx` (profile card / skills / certs / absence), `Onboarding.jsx` (the quest) — all consume the no-model REST surface.
