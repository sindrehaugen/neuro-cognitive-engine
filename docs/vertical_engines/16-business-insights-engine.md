...
- **Host Portal page served:** none yet — a future "Executive / Cockpit" admin surface (the morning-brief dashboard + board-pack export) consumes the no-model REST routes. Out of scope for the first build beyond the REST contract.
