> **Status:** shipped · **Verified-against:** `11f2cd1` (public `main`) · **Last-audited:** generated
...
|---|---|---|
| `TOOL_REGISTRY` entries | **519** MCP tools (70 shared + 449 across 25 engines) | AST of [`nce/tool_registry.py`](../../nce/tool_registry.py), pinned by `_EXPECTED_TOTAL = 519` in [`tests/test_tool_registry.py`](../../tests/test_tool_registry.py) |
...
- **Total Registered Tools:** 519
- **Shared Core Tools:** 70
- **Vertical Engine Tools:** 449 across 25 engine packages
...
- **Base Migrations:** 94 files (`001` → `098`)
