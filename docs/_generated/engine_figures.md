> **Status:** shipped · **Verified-against:** `f9c5666` (public `main`) · **Last-audited:** generated
...
|---|---|---|
| `TOOL_REGISTRY` entries | **368** MCP tools (69 shared + 299 across 24 engines) | AST of [`nce/tool_registry.py`](../../nce/tool_registry.py), pinned by `_EXPECTED_TOTAL = 368` in [`tests/test_tool_registry.py`](../../tests/test_tool_registry.py) |
...
- **Total Registered Tools:** 368
- **Shared Core Tools:** 69
- **Vertical Engine Tools:** 299 across 24 engine packages
