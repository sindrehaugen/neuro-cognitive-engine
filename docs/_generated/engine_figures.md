> **Status:** shipped · **Verified-against:** `58a1b90` (public `main`) · **Last-audited:** generated
...
| SQL migrations | 101 files (+1 optional), `001` → `105` — gaps at `002`, `009`, `010`, `059` | Files in [`nce/migrations/`](../../nce/migrations/) and [`nce/migrations/optional/`](../../nce/migrations/optional/) |
